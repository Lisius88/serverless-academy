...
const optsSecond = {
"reply_markup": {
          "keyboard": [["Forecast in Barcelona"]]
    }
}
...
bot.on('message', (msg) => {
  ...
  if (msg.text === '/start') {
  bot.sendMessage(chatId, "Hi! Do you want to know the weather in Barcelona?", {
      "reply_markup": {
          "keyboard": [["Forecast in Barcelona"]]
    }
})
...
bot.on('message', (msg) => {
    ...
    switch (text) {
        ...
        forecast(chatId)
        bot.sendMessage(chatId, "If you want to know the forecast for the day, select the interval you are interested in", opts)   
            break;
        ...
        forecastWithIntervalSecond(chatId)    
            break;
        case "/back":
        bot.sendMessage(chatId, "What do you want to see?", optsSecond)   
            break;
    }
});